...
fun deserializeMatrix4(transform: ArrayList<Double>): Triple<Vector3, Vector3, Quaternion> {
    ...
    val correctionZ = Quaternion(0.0f, 0.0f, 1.0f, 180f)
    val correctionY = Quaternion(0.0f, 1.0f, 0.0f, 180f)

    // Calculate resulting rotation quaternion by multiplying input and corrections
    rotation = Quaternion.multiply(Quaternion.multiply(inputRotation, correctionY), correctionZ)
